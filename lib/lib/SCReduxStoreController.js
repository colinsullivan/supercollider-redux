...
function () {
   ...
   **/
  function SCReduxStoreController(store) {
    var _this = this;

    _classCallCheck(this, SCReduxStoreController);
    ...
    this.store.subscribe(function () {
      _this.call("SCReduxStore.setState", [_this.store.getState()]);
    });
  }

  _createClass(SCReduxStoreController, [{
  ...
  return SCReduxStoreController;
}();

var _default = SCReduxStoreController;
